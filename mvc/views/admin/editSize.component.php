                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            <div class="form-group">
                                ...
                                <select name="category_id" id="category_id" class="form-control">
                                    ...
                                    foreach ($data['category'] as $index => $category) {
                                        if ($category['id'] != $data['size']['category_id']) {
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" value="<?= $data['size']['size'] ?>" name="size" id="size_id" class="form-control" placeholder="Enter size" required>
                            </div>
                            <p><?= $data['error'] ?></p>
                            <div class="form-group">
                                <button class="btn btn-success">Update</button>
                                <a href="/project/admin/size" class="btn btn-warning">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
