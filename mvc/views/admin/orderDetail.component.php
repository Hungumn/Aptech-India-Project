                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered black-color">
                            ...
                            <tbody>
                                <?php
                                    foreach ($data['orderDetail'] as $index => $orderDetail) {
                                        echo '<tr>
                                                <td>'.(++$index).'</td>
                                                <td><img src="' . str_replace("./public", "/project/public", $orderDetail['thumbnail']) . '" style="width: 80px;" alt=""></td>
                                                ...
                                                <td>'.$orderDetail['brand_name'].'</td>
                                                <td>'.$orderDetail['material_name'].'</td>
                                                <td>'.$orderDetail['color'].'</td>
                                                <td>'.$orderDetail['age'].'</td>
                                            </tr>';
                                    }
                                ?>
                            </tbody>
