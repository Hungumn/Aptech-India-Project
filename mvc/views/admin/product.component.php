                        ...
                        <table class="table table-bordered black-color">
                            ...
                            <tbody>
                                ...
                                foreach ($data['product'] as $index => $product) {
                                    echo '<tr>
                                    <td>' . (++$index) . '</td>
                                    <td><img src="' . str_replace("./public", "/project/public", $product['thumbnail']) . '" style="width: 80px;" alt=""></td>
                                    <td>' . $product['title'] . '</td>
                                    <td>$' . $product['price'] . '</td>
                                    ...
                                    <td><a href="/project/admin/productDetail/' . $product['id'] . '" class="btn btn-warning">Detail</a></td>
...
<script>
    ...
    deleteProduct = (id) => {
        ...
        if (deleteConfirm) {
            deleteForm.action = '/project/admin/deleteProduct/' + id;
            deleteForm.submit();
        }
    }
</script>